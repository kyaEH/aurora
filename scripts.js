...
$("input").change(function() {
	...
	$("#pvmax").val(Math.floor(10+$("#force").val()*1.25+$("#constitution").val()*2 + Number($("#poids").val()) / 15));
    //charisme = constitution/2 + intelligence/1.5 + charme
	$("#charisme").val(Math.min(17,5+Math.floor($("#constitution").val()/1.5+$("#intelligence").val()/1.5+$("#charme").val()*1+Number($("#taille").val()) / 75)));
});
